...
const ClientSection: React.FC<ClientSectionProps> = (props) => {
    const client =[
        {src: "assets/images/png/nb_client.png"},
        {src: "assets/images/png/carrefour_client.png"},
        {src: "assets/images/png/carrefour_client.png"},
        {src: "assets/images/png/carrefour_client.png"},
        {src: "assets/images/png/carrefour_client.png"},
        {src: "assets/images/png/carrefour_client.png"},
        ...
        <div className="container mx-auto px-4 lg:p-0">
            <div className="py-8">
                ...
                <div className="grid grid-cols-2 gap-4 md:gap-8 md:grid-cols-4">
                    {client.map((each)=>{
                        return <img src={each.src} alt="" className="shadow-lg rounded-md " style={{ boxShadow: "0px 0px 10px rgb(156,163,175,0.4)" }} />
                    })}
                </div>
            </div>
        </div>
