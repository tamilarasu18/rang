    ...
    <div className="bg-[#FFC48B]">
      <div className="lg:flex px-4 pt-6 mg:p-0 items-center justify-start custom-container">
        <div className="">
          ...
          <div className="bg-[#DE291B] monsterrat-semibold text-white rounded text-center w-[40%] md:w-[30%] lg:w-[40%] px-4 lg:px-8 py-2 lg:py-4 text-lg md:text-2xl lg:text-3xl">
