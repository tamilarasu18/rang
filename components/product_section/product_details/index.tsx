            ...
            <div className="custom-container">
                <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
                    {productImageList.map((each, index) => {
                        return <div onClick={()=>{routerFunction(each.query)}} key={index} className="w-full h-full rounded-2xl hover:bg-[#F44336] text-black hover:text-white" style={{ boxShadow: "0px 0px 10px rgb(156,163,175,0.4)" }}>
