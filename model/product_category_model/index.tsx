...
export const productImageList = [
  { src: "assets/images/webp/mens.webp", name: "Men's Clothings", query: "mens" },
  { src: "assets/images/webp/women.webp", name: "Women's Clothings", query: "womens" },
  { src: "assets/images/webp/kids.webp", name: "Kid's Clothings", query: "kids" },
  { src: "assets/images/webp/corporate.webp", name: "Corporate Clothings", query: "corporate" },
  { src: "assets/images/webp/school.webp", name: "School Uniforms", query: "school" },
  { src: "assets/images/webp/baby.webp", name: "Newborn Baby Clothing", query: "newborn" },
  { src: "assets/images/webp/sports.webp", name: "Sportswear", query: "sportswear" },
  { src: "assets/images/webp/sports_jersey.webp", name: "Sports Jersey's", query: "sports" },
  { src: "assets/images/webp/brands.webp", name: "Brand Label", query: "brand_label" },
  { src: "assets/images/webp/brand_accessoires.webp", name: "Brand Accessories", query: "brand_accessories" },
]
...
export const mensProductList = [
  { src: "assets/images/webp/mens_cloths/round_neck_tees.webp", name: "Round-Neck Tees" },
  { src: "assets/images/webp/mens_cloths/polo_tees.webp", name: "Polo Tees" },
  { src: "assets/images/webp/mens_cloths/sweatshirts.webp", name: "Sweatshirts-Tees" },
  { src: "assets/images/webp/mens_cloths/hoodies.webp", name: "Hoodie's" },
  { src: "assets/images/webp/mens_cloths/track_pants.webp", name: "Track Pants" },
  { src: "assets/images/webp/mens_cloths/joggers.webp", name: "Jogger's" },
  { src: "assets/images/webp/mens_cloths/shorts.webp", name: "Shorts" },
  { src: "assets/images/webp/mens_cloths/three_by_four.webp", name: "Three By Four" },
]

// womens product section
export const womensProductList = [
  { src: "assets/images/webp/womens_cloths/lycra_top.webp", name: "Lycra-Top" },
  { src: "assets/images/webp/womens_cloths/crop_top.webp", name: "Crop-Top" },
  { src: "assets/images/webp/womens_cloths/leggings.webp", name: "Leggings" },
  { src: "assets/images/webp/womens_cloths/hoodies.webp", name: "Hoodie's" },
  { src: "assets/images/webp/womens_cloths/tshirts.webp", name: "T-Shirts" }
]

// newborn product section
export const newbornProductList = [
  { src: "assets/images/webp/newborn/rompers.webp", name: "Rompers" },
  { src: "assets/images/webp/newborn/body_suit.webp", name: "Body Suit" },
  { src: "assets/images/webp/newborn/jump_suit.webp", name: "Jump Suit" },
  { src: "assets/images/webp/newborn/sleep_suit.webp", name: "Sleep Suit" },
  { src: "assets/images/webp/newborn/mittens.webp", name: "Mittens" },
  { src: "assets/images/webp/newborn/baby_blankets.webp", name: "Baby Blankets" },
  { src: "assets/images/webp/newborn/baby_gift_packs.webp", name: "Baby Gift Packs" },
]

// Brand Acceries product section
export const brandAcceriesProductList = [
  { src: "assets/images/webp/brand_acceries/tags.webp", name: "Tags" },
  { src: "assets/images/webp/brand_acceries/poly_bag.webp", name: "Poly Bag" },
  { src: "assets/images/webp/brand_acceries/printed_tag.webp", name: "Printed Tag" },
  { src: "assets/images/webp/brand_acceries/tranfered_stricker.webp", name: "Transfer Sticker" },
  { src: "assets/images/webp/brand_acceries/dtf.webp", name: "DTF (Direct To Film)" },
  { src: "assets/images/webp/brand_acceries/customized_foam_bag.webp", name: "Customized Foam Bag" },
  { src: "assets/images/webp/brand_acceries/uniform_flag.webp", name: "Uniform Flag" },
]

// Sports Wear product section
export const sportsWearProductList = [
  { src: "assets/images/webp/sports_jersey.webp", name: "Sports Jersey's" },
  { src: "assets/images/webp/sports_wear/gym_wears.webp", name: "Gym Wears" },
  { src: "assets/images/webp/sports_wear/tights.webp", name: "Tights" },
